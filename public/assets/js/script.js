document.addEventListener("DOMContentLoaded", () => {
    ...
    if (e) {
        new Glide(e, {
            ...
            perView: 4,
            gap: 20,
            breakpoints: { 640: { perView: 1 }, 768: { perView: 2 } },
        }).mount();
    }
...
const showBackdrop = (e) => {
        ...
        e
            ? t.setAttribute("class", "backdrop backdrop_workspace")
            : t.setAttribute("class", "backdrop"),
...
const customizer = () => {
    ...
    if (!t) return;
    const i = [
        { id: "default", label: "Sky", color: "#0284C7" },
        { id: "orange", label: "Orange", color: "#EA580C" },
        { id: "yellow", label: "Yellow", color: "#CA8A04" },
        { id: "green", label: "Green", color: "#65A30D" },
    ...
    const l = [{ id: "slate", label: "Slate", color: "#475569" }];
    let s = "";
    ...
    const m = () => {
            ...
            c
                ? (e.classList.add("theme-" + c),
                  (s = t.querySelector(
                      "[data-toggle='theme'][data-value='" + c + "']"
                  )))
                : (s = t.querySelector(
            ...
            m
                ? (e.classList.add("gray-" + m),
                  (p = t.querySelector(
                      "[data-toggle='gray'][data-value='" + m + "']"
                  )))
                : (p = t.querySelector(
            ...
            u
                ? (e.classList.add("font-" + u),
                  (g = t.querySelector(
                      "[data-toggle='font'][data-value='" + u + "']"
                  )))
                : (g = t.querySelector(
        ...
        y = (t) => {
            ...
            switch (
                (e.classList.remove("menu-icon-only"),
                ...
                case "hidden":
                    ...
                    break;
                default:
                    localStorage.removeItem("menuType"), a && showBackdrop(!0);
            }
        },
        b = () => {
        ...
        v = () => {
            o.querySelectorAll(".menu-detail.open").forEach((e) => {
                hideBackdrop(),
                    o.classList.contains("menu-wide") ||
                        e.classList.remove("open");
            });
        },
        w = (o) => {
            ...
            t
                .querySelector("[data-toggle='theme'][data-value='" + o + "']")
        ...
        S = (o) => {
            ...
            t
                .querySelector("[data-toggle='gray'][data-value='" + o + "']")
                .classList.add("active"),
                e.classList.forEach((t) => {
        ...
        L = (o) => {
            ...
            t
                .querySelector("[data-toggle='font'][data-value='" + o + "']")
                .classList.add("active"),
                e.classList.forEach((t) => {
                ...
                "default" == o
                    ...
                    : (e.classList.add("font-" + o),
                      localStorage.setItem("font", o));
            const a = new Event("ThemeChanged");
            document.dispatchEvent(a), location.reload();
        };
    on("#customizer", "click", '[data-toggle="customizer"]', () => {
        t.classList.contains("open")
            ? t.classList.remove("open")
            : (m(), t.classList.add("open"));
    }),
        ...
        on("#customizer", "click", '[data-toggle="rtl"]', () => {
            "ltr" === document.dir
                ? ((document.dir = "rtl"), localStorage.setItem("dir", "rtl"))
                : ((document.dir = "ltr"), localStorage.setItem("dir", "ltr"));
        }),
        on("#customizer", "click", "[data-toggle='menu-type']", (e) => {
            const t = e.target.closest("[data-toggle='menu-type']").dataset
                .value;
            y(t);
        }),
...
const darkMode = () => {
    ...
    o && e.classList.add(o), "dark" === o && t && (t.checked = "checked");
...
if ((darkMode(), "undefined" != typeof Chart)) {
    ...
    class r extends Chart.elements.LineElement {
        draw(e) {
            ...
            (e.stroke = function () {
                ...
                Chart.elements.LineElement.prototype.draw.apply(
                    this,
                    arguments
                );
        }
    }
    (r.id = "lineWithShadowElement"), Chart.register(r);
    class n extends Chart.controllers.line {}
    (n.id = "lineWithShadow"),
        (n.defaults = { datasetElementType: "lineWithShadowElement" }),
        Chart.register(n);
    ...
    (i.id = "barWithShadow"), Chart.register(i);
    class d extends Chart.controllers.pie {}
    (d.id = "pieWithShadow"),
        (d.defaults = { datasetElementType: "lineWithShadowElement" }),
        Chart.register(d);
    class l extends Chart.controllers.doughnut {}
    (l.id = "doughnutWithShadow"),
        (l.defaults = { datasetElementType: "lineWithShadowElement" }),
        Chart.register(l);
    class s extends Chart.controllers.radar {}
    (s.id = "radarWithShadow"),
        (s.defaults = { datasetElementType: "lineWithShadowElement" }),
        Chart.register(s);
    class c extends Chart.controllers.polarArea {}
    (c.id = "polarAreaWithShadow"),
        (c.defaults = { datasetElementType: "lineWithShadowElement" }),
        Chart.register(c);
    ...
    (m.id = "lineWithAnnotationAndShadow"),
        (m.defaults = { datasetElementType: "lineWithShadowElement" }),
        Chart.register(m);
    let g = "";
    if (((g = document.getElementById("visitorsChart")), g)) {
        ...
        t.addColorStop(0, "rgb(" + e.primary + "/ .5)"),
            t.addColorStop(0.75, "rgb(" + e.primary + "/ 0)");
        var visitorsChart = new Chart(g, {
            ...
            data: {
                ...
                datasets: [
                    {
                        data: [
                            6.25, 7.5, 10, 7.5, 10, 12.5, 10, 12.5, 10, 12.5,
                            15, 16.25,
                        ],
            ...
            options: {
                plugins: { legend: { display: !1 }, tooltip: a },
                scales: {
                    y: {
        ...
        var categoriesChart = new Chart(g, {
            ...
            options: {
                ...
                plugins: {
                    legend: {
                        position: "bottom",
                        labels: { usePointStyle: !0, padding: 20 },
                    },
                    tooltip: a,
                },
                scales: { r: { ticks: { display: !1 } } },
                layout: { padding: 5 },
            },
        });
    }
        ...
        g &&
            ...
            new Chart(g, {
                ...
                options: {
                    ...
                    scales: { r: { max: 30, ticks: { display: !1 } } },
                },
            })),
            ...
            plugins: {
                ...
                tooltip: {
                    ...
                    external: (e) => {
                        ...
                        (t.querySelector(".chart-heading").innerHTML = a),
                            (t.querySelector(".chart-value").innerHTML =
                                "$" + o),
                            (t.querySelector(".chart-label").innerHTML = r);
                    },
                },
...
const fullscreen = () => {
    ...
    on("body", "click", "#fullScreenToggler", () => {
        ...
        document.msFullscreenElement
            ...
            e.classList.contains("la-expand-arrows-alt")
                ? (e.classList.remove("la-expand-arrows-alt"),
                  e.classList.add("la-compress-arrows-alt"))
                : (e.classList.remove("la-compress-arrows-alt"),
...
const menu = () => {
    ...
    a && (e.classList.add(a), t.classList.add(a));
    const r = () => {
        ...
        i = () => {
            e.classList.add("menu-hidden"), t.classList.add("menu-hidden");
        },
        d = () => {
        ...
        on(".menu-items", "click", ".link", (e) => {
            ((e) => {
                ...
                if (a && !t.classList.contains("menu-wide")) {
                    ...
                    r(),
                        a && !e
                            ? (showBackdrop(!0), a.classList.add("open"))
                            : hideBackdrop();
                }
            })(e);
        }),
        ...
        ((e) => {
            ...
            "password" === t.type
                ? ((t.type = "text"),
                  ...
                  e.classList.add("text-primary", "dark:text-primary"))
                : ((t.type = "password"),
...
const sidebar = () => {
    ...
    if (!e) return;
    const t = () => {
            hideBackdrop(), e.classList.remove("open");
        },
        o = () => {
            e.classList.contains("open")
                ? t()
                : (showBackdrop(!0), e.classList.add("open"));
        };
    window.addEventListener(
        "resize",
        () => {
...
const toasts = () => {
    ...
    on("body", "click", '[data-toggle="toast"]', (t) => {
        ((t) => {
            ...
            (r = new DOMParser().parseFromString(r, "text/html").body
                .firstChild),
                e.appendChild(r),
